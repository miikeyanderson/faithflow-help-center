    ...
    <div className="min-h-screen">
      ...
      <div className="py-8">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-gray-600 dark:text-white mt-4 text-base">Please note that the Privacy Policy was last revised on December 8, 2025</p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-lg font-bold text-black dark:text-white mb-3 mt-6">a. Account Registration</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <h3 className="text-lg font-bold text-black dark:text-white mb-3 mt-6">b. Profile Page & User-Generated Content</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <h3 className="text-lg font-bold text-black dark:text-white mb-3 mt-6">c. AI Features</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <h3 className="text-lg font-bold text-black dark:text-white mb-3 mt-6">d. Speaking Activities</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <h3 className="text-lg font-bold text-black dark:text-white mb-3 mt-6">e. Contact Sync Feature</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <h3 className="text-lg font-bold text-black dark:text-white mb-3 mt-6">f. Activity Data & IP Addresses</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <h3 className="text-lg font-bold text-black dark:text-white mb-3 mt-6">g. Cookies</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <h3 className="text-lg font-bold text-black dark:text-white mb-3 mt-6">h. Google Analytics</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">How We Process Your Information</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <h3 className="text-lg font-bold text-black dark:text-white mb-3 mt-6">a. Providing and improving the Service</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <h3 className="text-lg font-bold text-black dark:text-white mb-3 mt-6">b. Communicating with you</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <h3 className="text-lg font-bold text-black dark:text-white mb-3 mt-6">c. Complying with law and preventing harmful activities</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <h3 className="text-lg font-bold text-black dark:text-white mb-3 mt-6">d. Personalized advertising</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <h3 className="text-lg font-bold text-black dark:text-white mb-3 mt-6">e. Anonymous information</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Your Data Subject Rights</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
              You may update or correct your information, and exercise certain opt-out rights, in your Settings page. To make a privacy-related request, please send an email to <a href="mailto:privacy@faithflowapp.com" className="text-white dark:text-white underline">privacy@faithflowapp.com</a>.
            </p>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          {/* Child Users */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Child Users</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Links to Third-Party Websites</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Privacy Policy Updates</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          {/* Data Transfer */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Data Transfer</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          {/* Contact Us */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Contact Us</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
              Faithflow is operated by <strong>Asymmetric Labs, LLC</strong>. Faithflow&apos;s headquarters are located within the United States.
            </p>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
              For all data privacy inquiries and any questions or concerns you have about this Privacy Policy, please contact us at <a href="mailto:privacy@faithflowapp.com" className="text-white dark:text-white underline">privacy@faithflowapp.com</a>.
            </p>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
              For all support inquiries, please visit our <Link href="/help" className="text-white dark:text-white underline">Help Center</Link>.
            </p>
          </section>
