      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 dark:text-white mb-4 text-lg leading-relaxed">
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 text-gray-700 dark:text-white space-y-2 mb-4 text-lg leading-relaxed">
