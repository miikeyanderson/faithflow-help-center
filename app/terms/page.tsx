    ...
    <div className="min-h-screen">
      ...
      <div className="py-8">
        <div className="max-w-3xl mx-auto px-4">
          <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Terms and Conditions of Service</h1>
          <p className="text-gray-600 dark:text-white mt-4 text-base">Please note that these Terms and Conditions of Service were last revised on December 7th, 2025</p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">General</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-semibold">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Description of Website and Service</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Acceptable Use of the Service</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <ul className="list-disc pl-6 text-gray-700 dark:text-white space-y-3 mb-5 text-lg leading-loose font-medium">
          ...
          {/* Additional Terms */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Additional Terms</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          {/* Registration */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Registration</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
              When creating an account, you agree to:
            </p>
            <ol className="list-decimal pl-6 text-gray-700 dark:text-white space-y-3 mb-5 text-lg leading-loose font-medium">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Your Representations and Warranties</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Submission of Content</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          {/* Indemnification */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Indemnification</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          {/* License to Apps */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">License to Apps</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          {/* In-App Purchases */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">In-App Purchases</h2>

            <h3 className="text-xl font-semibold text-black dark:text-white mb-3 mt-6">Automatic Renewal</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <h3 className="text-xl font-semibold text-black dark:text-white mb-3 mt-6">Virtual Items</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <h3 className="text-xl font-semibold text-black dark:text-white mb-3 mt-6">Fees and Taxes</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
              You agree to pay all fees and taxes associated with purchases made through the Service.
            </p>

            <h3 className="text-xl font-semibold text-black dark:text-white mb-3 mt-6">Payment Processors</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <h3 className="text-xl font-semibold text-black dark:text-white mb-3 mt-6">Refund Policy</h3>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Third-Party Links and Services</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">No Representations or Warranties</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Limitation of Liability</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          {/* Termination */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Termination</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          {/* Proprietary Rights */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Proprietary Rights</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          {/* Trademarks */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Trademarks</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          {/* Privacy */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Privacy</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
              Use of the Service is governed by our Privacy Policy at <Link href="/privacy" className="text-white dark:text-white underline">faithflowapp.com/privacy</Link>.
            </p>
          </section>

          {/* Promotion Codes */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Promotion Codes</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Copyright Complaints (DMCA)</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <div className="bg-gray-100 dark:bg-[#121F25] p-4 rounded-md mb-4">
              ...
              <p className="text-gray-700 dark:text-white">Email: <a href="mailto:legal@faithflowapp.com" className="text-white dark:text-white underline">legal@faithflowapp.com</a></p>
            </div>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          {/* Governing Law */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Governing Law</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          {/* Choice of Forum */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Choice of Forum</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Dispute Resolution &amp; Arbitration</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
            ...
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
              You may opt out by emailing <a href="mailto:legal@faithflowapp.com" className="text-white dark:text-white underline">legal@faithflowapp.com</a> within 30 days of account creation.
            </p>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          {/* Language */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Language</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">California Residents</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
          ...
          {/* Miscellaneous */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black dark:text-white mb-3">Miscellaneous</h2>
            <p className="text-gray-700 dark:text-white mb-5 text-lg leading-loose font-medium">
