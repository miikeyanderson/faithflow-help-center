    ...
    <div className="min-h-screen">
      ...
      <div className="py-8">
        <div className="max-w-3xl mx-auto px-4">
          <h1 className="text-2xl font-semibold text-gray-800 dark:text-white">Terms and Conditions of Service</h1>
          <p className="text-gray-600 dark:text-white mt-4">Last revised on December 7th, 2025</p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Description of Website and Service</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Acceptable Use of the Service</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          {/* Additional Terms */}
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Additional Terms</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          {/* Registration */}
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Registration</h2>
            <p className="text-gray-700 dark:text-white mb-4">
              When creating an account, you agree to:
            </p>
            <ol className="list-decimal pl-6 text-gray-700 dark:text-white space-y-2 mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Your Representations and Warranties</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Submission of Content</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          {/* Indemnification */}
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Indemnification</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          {/* License to Apps */}
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">License to Apps</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          {/* In-App Purchases */}
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">In-App Purchases</h2>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Third-Party Links and Services</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">No Representations or Warranties</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          {/* Proprietary Rights */}
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Proprietary Rights</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          {/* Trademarks */}
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Trademarks</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          {/* Privacy */}
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Privacy</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          {/* Promotion Codes */}
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Promotion Codes</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Copyright Complaints (DMCA)</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          {/* Governing Law */}
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Governing Law</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          {/* Choice of Forum */}
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Choice of Forum</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Dispute Resolution &amp; Arbitration</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          {/* Language */}
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Language</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">California Residents</h2>
            <p className="text-gray-700 dark:text-white mb-4">
          ...
          {/* Miscellaneous */}
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Miscellaneous</h2>
            <p className="text-gray-700 dark:text-white mb-4">
